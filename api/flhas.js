  ...
  try {
    ...
    if (action === 'list') {
      ...
      let query = supabaseAdmin
        .from('flhas')
        .select('id, worker_name, job_site, site_id, created_at, hazards_json, signed_by, company_id, pdf_url, status, supervisor_signed_by, supervisor_signed_at, worker_signature')
        .order('created_at', { ascending: false });

...
- Identify all hazards genuinely relevant to this task — typically 4-8, sometimes fewer for a simple task, sometimes more for a task with several distinct activities. A hazard belongs on the list if EITHER of these is true:
  ...
  Do NOT pad the list to hit a number, and do NOT add a hazard that belongs to a DIFFERENT kind of job than the one described (e.g. don't add fall-from-height hazards to ground-level work). The test for inclusion is "would this hazard actually occur doing the described work" — not "is there a literal keyword match in the task text," and not "is there an SOP to cite."
